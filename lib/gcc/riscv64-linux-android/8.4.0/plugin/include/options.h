...
enum opt_code
{
  ...
  OPT_mstack_protector_guard_offset_ = 1238, /* -mstack-protector-guard-offset= */
  OPT_mstack_protector_guard_reg_ = 1239,    /* -mstack-protector-guard-reg= */
  OPT_mstack_protector_guard_ = 1240,        /* -mstack-protector-guard= */
  OPT_mstrict_align = 1241,                  /* -mstrict-align */
  OPT_mstrip_sextw = 1242,                   /* -mstrip-sextw */
  OPT_mthread_jumps1 = 1243,                 /* -mthread-jumps1 */
  OPT_mtst = 1244,                           /* -mtst */
  OPT_mtune_ = 1245,                         /* -mtune= */
  OPT_muclibc = 1246,                        /* -muclibc */
  OPT_mvlen_ = 1247,                         /* -mvlen= */
  OPT_mxor_combine = 1248,                   /* -mxor-combine */
  OPT_n = 1249,                              /* -n */
  OPT_no_canonical_prefixes = 1250,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1251,              /* -no-integrated-cpp */
  OPT_no_pie = 1252,                         /* -no-pie */
  ...
  OPT_static_pie = 1303,                     /* -static-pie */
  /* OPT_std_c__03 = 1304, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1305, */                /* -std=c++0x */
  OPT_std_c__11 = 1306,                      /* -std=c++11 */
  OPT_std_c__14 = 1307,                      /* -std=c++14 */
  OPT_std_c__17 = 1308,                      /* -std=c++17 */
  /* OPT_std_c__1y = 1309, */                /* -std=c++1y */
  /* OPT_std_c__1z = 1310, */                /* -std=c++1z */
  OPT_std_c__2a = 1311,                      /* -std=c++2a */
  OPT_std_c__98 = 1312,                      /* -std=c++98 */
  OPT_std_c11 = 1313,                        /* -std=c11 */
  OPT_std_c17 = 1314,                        /* -std=c17 */
  /* OPT_std_c18 = 1315, */                  /* -std=c18 */
  ...
  OPT_std_f2018 = 1324,                      /* -std=f2018 */
  OPT_std_f95 = 1325,                        /* -std=f95 */
  OPT_std_gnu = 1326,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1327, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1328, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1329,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1330,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 1331,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1332, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 1333, */              /* -std=gnu++1z */
  OPT_std_gnu__2a = 1334,                    /* -std=gnu++2a */
  OPT_std_gnu__98 = 1335,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1336,                      /* -std=gnu11 */
  OPT_std_gnu17 = 1337,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 1338, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 1339, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1340, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1341,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1342,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1343, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1344, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1345,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1346, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1347, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1348, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 1349, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 1350, */         /* -std=iso9899:2018 */
  OPT_std_legacy = 1351,                     /* -std=legacy */
  OPT_symbolic = 1352,                       /* -symbolic */
  OPT_t = 1353,                              /* -t */
  OPT_time = 1354,                           /* -time */
  OPT_time_ = 1355,                          /* -time= */
  OPT_traditional = 1356,                    /* -traditional */
  OPT_traditional_cpp = 1357,                /* -traditional-cpp */
  OPT_trigraphs = 1358,                      /* -trigraphs */
  OPT_u = 1359,                              /* -u */
  OPT_undef = 1360,                          /* -undef */
  OPT_v = 1361,                              /* -v */
  OPT_version = 1362,                        /* -version */
  OPT_w = 1363,                              /* -w */
  OPT_wrapper = 1364,                        /* -wrapper */
  OPT_x = 1365,                              /* -x */
  OPT_z = 1366,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
